...
class MyCalendarStyle {
  ...
  const MyCalendarStyle({
    this.weekdayStyle = const TextStyle(color: Colors.white),
    this.weekendStyle =
    ...
    this.selectedStyle = const TextStyle(
        ...
        fontSize: 20.0,
        fontFamily: 'Calendar'), // Material grey[50]
    this.todayStyle = const TextStyle(
        color: const Color(0xFFFAFAFA),
        fontSize: 20.0,
        decoration: TextDecoration.underline,
        fontFamily: 'Calendar',
        fontWeight: FontWeight.w700), // Material grey[50]
    this.outsideStyle =
    ...
    this.markersColor = Colors.white, // Material blueGrey[900]
    this.markersAlignment = Alignment.bottomCenter,
    this.markersPositionTop,
    this.markersPositionBottom = 15.0,
    this.markersPositionLeft=12,
